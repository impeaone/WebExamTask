...
Сайт размещен по [ссылке](https://impeaone.github.io/WebExamTask/).
...
### Главная страница
![Главная страница сайта языковой школы](Demonstration/главная-страница.gif)

### Личный кабинет
![Добавление и редактирование курсов и тьюторов](Demonstration/личный-кабинет.gif)

### Интерактивная карта
![Интерактивная карта](Demonstration/дополнительное-задание.gif)
